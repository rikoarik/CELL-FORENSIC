...
typedef ARTrackingResultHandler = void Function(
    String state, String? failureReason);
...
class ARSessionManager {
  ...
  /// Receives ARCore camera tracking transitions from the Android bridge.
  ARTrackingResultHandler? onTrackingChanged;
  ...
  /// Clears the Android bridge's stable-plane cache so a deliberate scene
  /// reset requires a fresh stable-plane observation before the next anchor.
  Future<void> resetPlaneDetection() =>
      _channel.invokeMethod<void>('resetPlaneDetection');
