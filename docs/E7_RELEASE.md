...
Artifact: `build/web/` — host on any static HTTPS origin (Firebase Hosting, Cloudflare Pages, nginx, etc.).
...
2. Open hosted dashboard → active session + groups visible.
